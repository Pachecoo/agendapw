...
if (!empty($erros)) {
    ...
    $sql = " update tbl_contatos set nome=\"$nome\", endereco=\"$endereco\",nro_endereco=\"$nro_endereco\", 
    ...
    <html>
        <head>
            <META http-equiv=\"refresh\" content=\"1;URL=http://localhost:8088/agenda/pages/lista-contato.php\">
        </head>
    </html>";
}
?>